...
import com.imooc.huayujun.utils.IpUtils;
import com.imooc.huayujun.utils.PayUtil;
import com.imooc.huayujun.utils.StringUtils;
import com.imooc.huayujun.vo.OrderVO;
...
public class UserService {
    ...
    public Map<String, Object> wxPay(Integer openid, HttpServletRequest request){
        ...
        try{
            ...
            //调用统一下单接口，并接受返回的结果
            String result = PayUtil.httpRequest(WxPayConfig.createOrderUrl, "POST", xml);
